<%!
    ...
    git_link_template = 'https://github.com/lluissalord/sentiment_trader/blob/{commit}/{path}#L{start_line}-L{end_line}'
    ...
    search_query = 'inurl:github.com/lluissalord/sentiment_trader  site:sentiment_trader.github.io  site:sentiment_trader.website'
